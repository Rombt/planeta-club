...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__('Social Networks Settings', 'rombt_pc'),
		...
		'fields' => array(
			...
			array(
				...
				'type' => 'section',
				'title' => esc_html__('Facebook section', 'rombt_pc'),
				// 'subtitle' => esc_html__('Enter phone number and set his name', 'rombt_pc'),
				'indent' => true
			),
			array(
				'id' => 'rmbt-social-networks_fb-link',
				'type' => 'text',
				'title' => esc_html__('Facebook link', 'rombt_pc'),
			...
			array(
				...
				'type' => 'media',
				'url' => true,
				'title' => esc_html__('Facebook icon', 'rombt_pc'),
				'compiler' => 'true',
				'preview_size' => 'full',
				// 'default' => array(
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__('Image description for FaceBook icon', 'rombt_pc'),
			...
			array(
				...
				'type' => 'section',
				'title' => esc_html__('Instagram section', 'rombt_pc'),
				// 'subtitle' => esc_html__('Enter phone number and set his name', 'rombt_pc'),
				'indent' => true
			),
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__('Instagram link', 'rombt_pc'),
			...
			array(
				...
				'type' => 'media',
				'url' => true,
				'title' => esc_html__('Instagram icon', 'rombt_pc'),
				'compiler' => 'true',
				'preview_size' => 'full',
				// 'default' => array(
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__('Image description for instagram icon', 'rombt_pc'),
				'default' => esc_html__('', 'rombt_pc'),
			),
			...
			array(
				...
				'type' => 'section',
				'title' => esc_html__('Youtube section', 'rombt_pc'),
				// 'subtitle' => esc_html__('Enter phone number and set his name', 'rombt_pc'),
				'indent' => true
			),
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__('Youtube link', 'rombt_pc'),
			...
			array(
				...
				'type' => 'media',
				'url' => true,
				'title' => esc_html__('Youtube icon', 'rombt_pc'),
				'compiler' => 'true',
				'preview_size' => 'full',
				// 'default' => array(
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__('Image description for youtube icon', 'rombt_pc'),
				'default' => esc_html__('', 'rombt_pc'),
			),
