...
function rmbt_pc_scripts_admin() {
	wp_enqueue_style( 'rmbt_pc-admin_main', plugins_url() . '/core-plugin/assets/styles/main-style.min.css', array(), '1.0', 'all' );
	wp_enqueue_script( 'rmbt_pc-admin_core_jq', plugins_url() . '/core-plugin/assets/js/admin.main.min.js', array( 'jquery' ), '1.0', true );
}
add_action( 'admin_enqueue_scripts', 'rmbt_pc_scripts_admin' );
